...
const Auth = () => {
    ...
    //declared router after an await for login
    const router = useRouter();

    // useState for Login and Register
    const [email, setEmail] = useState('');
    const [name, setName] = useState('');
    const [password, setPassword] = useState('');

    //variant for login or register
        ...
        <div className="flex justify-center">
          <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
            ...
            <div className="flex flex-row items-center gap-4 mt-8 justify-center">
              ...
              <div onClick={() => signIn('github', { callbac2kUrl: '/profiles' })} className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition">
                <ImGithub size={32} />
              </div>
            </div>
            <p className="text-neutral-500 mt-12">
